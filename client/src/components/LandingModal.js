...
const LandingModal = () => {
  ...
  return (
    ...
    <Modal isOpen={isOpen}
      ...
      <img className="dino-modal-image" src="https://codeclan.com/wp-content/uploads/2019/04/CodeClan-Logo-White-2019-01.png"/>
      <p>{randomFact}</p>
      <button className="dino-modal-close-button"
        onClick={toggleModal} type="button"> Dinopedia
      </button>
